...
mejs.plugins = {
	...
	flash: [
		{version: [9,0,124], types: ['video/mp4','video/m4v','video/mov','video/flv','video/f4v','video/x-flv','audio/flv','audio/x-flv','audio/mp3','audio/m4a','audio/mpeg']}
...
mejs.HtmlMediaElementShim = {
	...
	getTypeFromFile: function(url) {
		...
		return (/(mp4|m4v|ogg|ogv|webm|flv|f4v|wmv|mpeg|mov)/gi.test(ext) ? 'video' : 'audio') + '/' + ext;
	},
...
(function ($) {
	...
	mejs.MediaElementPlayer.prototype = {
        ...
        next = rail.nextUntil(breakLine);
				others = $.merge(prevs,next) // rail.siblings();
        // END CUSTOM CODE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		...
		buildoverlays: function(player, controls, layers, media) {
			...
			var 
			loading = 
				$('<div class="mejs-overlay mejs-layer mejs-loading">'+
