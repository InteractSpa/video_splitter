module VideoSplitter
  class Inspector
    ...
    #
    #   file = VideoSplitter::Inspector.new(options_hash)
    #
    ...
    #
    # :raw_response is the full output of "ffmpeg -i [file]".
    #
    # :ffmpeg_binary is an optional argument that specifies the path to the
    # ffmpeg binary to be used. If a path is not explicitly declared, VideoSplitter
